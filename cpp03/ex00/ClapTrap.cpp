...
/*   Updated: 2024/09/09 19:35:09 by mcatalan@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : name("undefined") {
...
// Operator =
ClapTrapp &ClapTrap::operator=(const ClapTrap &src) {
...
std::string ClapTrap::getHitPoints() const { return(_hitPoints);}

std::string ClapTrap::getEnergyPoints() const { return(_energyPoints);}

std::string ClapTrap::getAttackDamage() const { return(_attackDamage);}
...
void	ClapTrap::attack(const std::string &target) {
	if ( this->_hitPoints == 0)
		std::cout << "ClapTrap " << this->_name << " can not attack (o hit points)." << std::endl;
	else if (this->_energyPoints == 0)
		std::cout << "ClapTrap " << this->_name << " can not attack (0 energy points)." << std::endl;
	else {
		this->_energyPoints--;
		std::cout << "ClapTrap " << this->name << " attacks " << target << " causing " << this->_attackDamage;
